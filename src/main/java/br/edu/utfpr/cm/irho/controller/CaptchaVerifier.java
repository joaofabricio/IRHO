 ...
 */
public class CaptchaVerifier extends OncePerRequestFilter {
	...
	private CaptchaCapture captchaCaptureFilter;
		...
		if (captchaCaptureFilter.getRecaptcha_response() != null) {
			...
			if (!reCaptchaResponse.isValid()) {
				...
				failureHandler.onAuthenticationFailure(req, res,
						new BadCredentialsException("Captcha inválido! Por favor, digite novamente as duas palavras."));
				failureHandler.setUseForward(true);
				
//				throw new BadCredentialsException("Captcha inválido! Por favor, digite novamente as duas palavras.");
	...
	public CaptchaCapture getCaptchaCaptureFilter() {
		return captchaCaptureFilter;
	}

	public void setCaptchaCaptureFilter(CaptchaCapture captchaCaptureFilter) {
